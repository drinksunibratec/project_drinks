			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
							...
							<tr>
								...
								<td align="center">
									<button type="button" class="btn btn-primary btn-lg"
										data-toggle="modal"
										data-target="#myModal<?php echo $pedido['codPedido']; ?> ">Detalhes</button>
								</td>
							</tr>
						</tbody>						
                                <?php
					...
					<div class="modal fade"
						id="myModal<?php echo $pedido['codPedido']; ?>" tabindex="-1"
						role="dialog" aria-labelledby="myModalLabel">
						<!-- Modal Dialog-->
						<div class="modal-dialog" role="document" style="width: 900px; height: 500px;">
							<!-- Modal Content-->
								...
								<div class="modal-body">
									...
									<div class="row">
										<div class="form-group col-md-4">
											<label for="dataPedido">Dt. Pedido</label> <input
												type="datetime" class="form-control" name="dataPedido"
										...
										<div class="form-group col-md-3">
											<label for="valorTotal">Valor</label> <input type="text"
												...
												value="<?php echo " R$ " . $pedido['valorTotal']; ?>"
												readonly>
										</div>
									</div>
									...
									<div class="row">
										<table border="1" class="table table-bordered table-striped">
											...
											<tbody>
                                                    <?php
                                                    $pdo = detalhesPedido($codEstabelecimento);
                                                    foreach ($pdo as $row) {
                                                        echo '<tr>';
