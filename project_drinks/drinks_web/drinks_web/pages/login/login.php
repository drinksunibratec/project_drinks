                	...
                	<div class="col-md-4" style="margin-top: 6%;">
                    	<div class="login-panel panel panel-default">
                    		<div class="panel-heading">
                                    <h2 class="panel-title" style="font-family: fantasy">Login</h2>
                    		</div>
                    		...
                    		<form class="col s12" method="POST" class="login-form">
                        		<div class="panel-body">
                    				...
                    				<input tabindex="2" type="submit" value="Entrar" class="btn btn-lg btn-primary btn-block" style="text-transform: uppercase; background: #120A8F" required/>
                        		</div>
                    		</form>
