...
<html lang="pt-br">
  ...
  ?>
        ...
        <?php
          ...
          if($sql->rowCount() > 0){
            ...
            foreach ($sql-> fetchAll() as $produto) {
                    echo'<td></td>';
                    echo '<td rowspan="2">'.$produto['codProduto'].'</td>';
                    echo'<td>'.$produto['nome']. '</td>';
                    echo'<td>'.$produto['descricao'].'</td>';
                    echo'<td>'.$produto['gelada'].'</td>';
                    echo'<td>'.$produto['preco'].'</td>';
                    echo'<td>'.$produto['CodEstabelecimento'].'</td>';
      ...
      <a href="adicionar-produto.php" class="btn btn-success">&#10010; Novo Produto</a>
