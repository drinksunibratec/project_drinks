...
<html lang="pt-br">
  ...
  <form method = "POST"> 
      ...
      CNPJ<br/>
      <input type="text" name="cnpj" value="<?php echo $dado['cnpj']; ?> "/><br/>
      Email<br/>
      <input type="text" name="email" value="<?php echo $dado['email']; ?> "/><br/>
      Bairro<br/>
      <input type="text" name="bairro" id="campoBairro" value="<?php echo $dado['bairro']; ?> "/><br/>
      Cep<br/>
      <input type="text" name="cep" id="campoCep" value="<?php echo $dado['cep']; ?> "/><br/>
      <br/>
      Cidade<br/>
      <input type="text" name="cidade" id="campoCidade" value="<?php echo $dado['cidade']; ?> "/><br/>
      <br/>
      Latitude<br/>
      <input type="text" name="latitude" id="campoLatitude" value="<?php echo $dado['latitude']; ?> "/><br/>
      <br/>
      Longitude<br/>
      <input type="text" name="longitude" id="campoLongitude" value="<?php echo $dado['longitude']; ?> "/><br/>
      <br/> 
      Numero<br/>
      <input type="text" name="numero" id="campoNumero" value="<?php echo $dado['Numero']; ?> "/><br/>
      <br/> 
      Rua<br/>
      <input type="text" name="rua" id="campoRua" value="<?php echo $dado['rua']; ?> "/><br/>
      <br/> 
      UF<br/>
      <input type="text" name="uf" id="campoUf" value="<?php echo $dado['uf']; ?> "/><br/>
      <br/>
      Nome Fantasia<br/>
      <input type="text" name="nomeFantasia" id="campoNomeFantasia" value="<?php echo $dado['nomeFantasia']; ?> "/><br/>
      <br/>
      Razao Social<br/>
      <input type="text" name="cep" id="campoRazaoSocial" value="<?php echo $dado['razaoSocial']; ?> "/><br/>
      <br/>
      Senha<br/>
      <input type="text" name="cep" id="campoSenha" value="<?php echo $dado['senha']; ?> "/><br/>
      <br/>
      Telefone<br/>
      <input type="text" name="cep" id="campoTelefone" value="<?php echo $dado['telefone']; ?> "/><br/>
      <br/>
      <input type="submit" value = "&#10003 Alterar" class="btn btn-primary" />
      <a href="cadastro-estabelecimento.php" class="btn btn-danger">&#10005 Cancelar</a>
